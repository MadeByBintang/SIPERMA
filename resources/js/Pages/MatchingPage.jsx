...
export function MatchingPage({ currentUserName, userRole }) {
  ...
  const allMatchingData = [
    {
      ...
      studentDescription: 'Passionate about AI and its applications in real-world problems. Looking forward to working on innovative research projects.',
      studentGPA: 3.85,
      ...
      lecturerDescription: 'Specializes in deep learning and neural networks with 10+ years of research experience in AI applications.',
    ...
    },
    {
      ...
      studentDescription: 'Interested in statistical analysis and big data processing. Eager to explore predictive modeling.',
      studentGPA: 3.75,
      ...
      lecturerDescription: 'Expert in statistical modeling and data analytics with numerous publications in top-tier journals.',
    ...
    },
    {
      ...
      studentDescription: 'Enthusiastic about full-stack development and modern web frameworks. Strong portfolio in web projects.',
      studentGPA: 3.65,
      ...
      lecturerDescription: 'Focuses on software architecture and web technologies with industry experience in tech companies.',
    ...
    },
    {
      ...
      studentDescription: 'Passionate about creating user-friendly mobile applications. Experience with both iOS and Android.',
      studentGPA: 3.80,
      ...
      lecturerDescription: 'Specializes in mobile computing and IoT systems. Active in mobile app development research.',
    ...
    },
    {
      ...
      studentDescription: 'Focused on network security and cryptography. Interested in ethical hacking and security audits.',
      studentGPA: 3.70,
      ...
      lecturerDescription: 'Renowned expert in cybersecurity and network protocols. Leading researcher in cryptography.',
    ...
    },
    {
      ...
      studentDescription: 'Interested in image processing and object detection. Working on autonomous vehicle perception systems.',
      studentGPA: 3.92,
      recommendedLecturer: 'Dr. Sarah Wijaya, M.Kom',
      lecturerNIP: '198501122010122001',
      lecturerExpertise: 'Machine Learning & AI',
    ...
    },
    {
      ...
      studentDescription: 'Enthusiastic about distributed systems and cloud infrastructure. Experience with AWS and Azure platforms.',
      studentGPA: 3.68,
      ...
      lecturerDescription: 'Expert in cloud architecture and distributed computing. Consultant for major tech companies on cloud migration.',
      lecturerCurrentStudents: 5,
      lecturerMaxStudents: 8,
      matchScore: 91,
      availability: 'Available',
    ...
    },
    {
      ...
      studentDescription: 'Passionate about text analysis and language models. Working on Indonesian language sentiment analysis.',
      studentGPA: 3.78,
      ...
      lecturerDescription: 'Specializes in natural language processing for Indonesian and regional languages. Published extensively in NLP conferences.',
      lecturerCurrentStudents: 4,
      lecturerMaxStudents: 8,
      matchScore: 96,
      availability: 'Available',
    ...
    },
    {
      ...
      studentDescription: 'Focused on human-computer interaction and user experience design. Portfolio includes mobile and web interfaces.',
      studentGPA: 3.72,
      recommendedLecturer: 'Dr. Rina Kusuma, M.T',
      lecturerNIP: '198209052008012003',
      lecturerExpertise: 'Software Engineering',
    ...
    },
    {
      ...
      studentDescription: 'Interested in decentralized systems and cryptocurrency. Exploring smart contract development and DeFi applications.',
      studentGPA: 3.81,
      recommendedLecturer: 'Prof. Linda Wijaya, Ph.D',
      lecturerNIP: '197512201995122001',
      lecturerExpertise: 'Security & Networks',
    ...
    },
    {
      ...
      studentDescription: 'Passionate about interactive entertainment and game engines. Experience with Unity and Unreal Engine.',
      studentGPA: 3.65,
      ...
      lecturerDescription: 'Expert in computer graphics and game development. Previously worked as senior developer at game studios.',
    ...
    },
    {
      ...
      studentDescription: 'Focused on large-scale data processing and analytics. Working with Hadoop, Spark, and data warehousing.',
      studentGPA: 3.88,
      recommendedLecturer: 'Prof. Ahmad Suryanto, Ph.D',
      lecturerNIP: '197803151998031002',
      lecturerExpertise: 'Data Science & Analytics',
  ...
  const filteredMatches = matchingData.filter((match) => {
    ...
    if (filterAvailability === 'available') return match.availability === 'Available';
    if (filterAvailability === 'limited') return match.availability === 'Limited';
    if (filterAvailability === 'unavailable') return match.availability === 'Not Available';
    return true;
  });
    ...
    <div className="space-y-6">
        ...
        <CardHeader>
          <div className="space-y-4 md:space-y-0">
            ...
            <div className="md:hidden space-y-4">
              ...
              {userRole === 'student' && (
                <Select value={recommendationType} onValueChange={(value) => setRecommendationType(value)}>
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Select recommendation type" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="students">Student Recommendations</SelectItem>
                    <SelectItem value="lecturers">Lecturer Recommendations</SelectItem>
                  </SelectContent>
                </Select>
              )}
                    ...
                    <TableRow key={match.id}>
                      {recommendationType === 'students' ? (
                        <>
                          <TableCell>
                            <div>
                              <p>{match.studentName}</p>
                              <p className="text-xs text-muted-foreground">{match.studentNIM}</p>
                            </div>
                          </TableCell>
                          <TableCell>{match.studentInterest}</TableCell>
                          <TableCell>
                        ...
                        <>
                          <TableCell>
                            <div>
                              <p>{match.recommendedLecturer}</p>
                              <p className="text-xs text-muted-foreground">{match.lecturerNIP}</p>
                            </div>
                          </TableCell>
                          <TableCell>{match.lecturerExpertise}</TableCell>
                          <TableCell>
                            <Badge className={getMatchColor(match.matchScore)}>
                              {match.matchScore}%
                            </Badge>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {recommendationType === 'students' ? 'Student' : 'Lecturer'} Matching Details
            </DialogTitle>
            <DialogDescription>
              {recommendationType === 'students' 
              ...
              <div className="flex items-center justify-between p-4 bg-accent rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Compatibility rating based on interests and availability
                  </p>
                </div>
                <Badge className={`${getMatchColor(selectedMatch.matchScore)} text-lg px-4 py-2`}>
                ...
                <>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        ...
                        <p>{selectedMatch.studentName}</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-sm text-muted-foreground">NIM</p>
                        <p>{selectedMatch.studentNIM}</p>
                      </div>
                      <div className="space-y-1">
                      ...
                      <div className="space-y-1">
                        ...
                        <Badge variant="secondary">{selectedMatch.studentGPA}</Badge>
                      </div>
                      <div className="space-y-1 col-span-2">
                        <p className="text-sm text-muted-foreground">Interest Area</p>
                        <Badge>{selectedMatch.studentInterest}</Badge>
                      </div>
                      <div className="space-y-1 col-span-2">
                        <p className="text-sm text-muted-foreground">Description</p>
                        <p className="text-sm">{selectedMatch.studentDescription}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1">
                        <p className="text-sm text-muted-foreground">Name</p>
                        <p>{selectedMatch.recommendedLecturer}</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-sm text-muted-foreground">NIP</p>
                        <p>{selectedMatch.lecturerNIP}</p>
                      </div>
                      <div className="space-y-1 col-span-2">
                        <p className="text-sm text-muted-foreground">Email</p>
                        <p className="flex items-center gap-1 text-sm">
                      ...
                      <div className="space-y-1 col-span-2">
                        ...
                        <Badge>{selectedMatch.lecturerExpertise}</Badge>
                      </div>
                      <div className="space-y-1 col-span-2">
                        <p className="text-sm text-muted-foreground">Description</p>
                        <p className="text-sm">{selectedMatch.lecturerDescription}</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-sm text-muted-foreground">Current Students</p>
                        <p>{selectedMatch.lecturerCurrentStudents} / {selectedMatch.lecturerMaxStudents}</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-sm text-muted-foreground">Availability</p>
                        <Badge className={getAvailabilityColor(selectedMatch.availability)}>
