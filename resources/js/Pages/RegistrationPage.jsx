...
export default function RegistrationPage() {
    ...
    const [selectedAssistantSupervisor, setSelectedAssistantSupervisor] =
        useState(null);
    ...
    const [selectedCompetitionSupervisor, setSelectedCompetitionSupervisor] =
        useState(null);
                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="pkl-company">
                                        Preferred Company/Institution (Optional)
                                    </Label>
                                    <Input
                                        id="pkl-company"
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Students with matching interests and
                                ...
                                {selectedTeamMembers.length > 0 && (
                                    <div className="mt-4 p-3 bg-accent rounded-lg">
                                        <p className="text-sm">
                                            ...
                                            {selectedTeamMembers.length} team
                                            member(s) selected
                                        </p>
                                    </div>
                                )}
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Lecturers with expertise matching your
                                    interests
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                        ...
                        {competitionFormData.competitionField && (
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Students matching your selected field:{" "}
                                        {competitionFormData.competitionField}
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                                ...
                                                {recommendedTeamMembers.map(
                                                    (member) => (
                                                        ...
                                                        >
                                                            <TableCell>
                                                                <Checkbox
                                                                    checked={selectedCompetitionTeam.includes(
                                                                        member.id
                                                                    )}
                                                                    onCheckedChange={() => {
                                                                        setSelectedCompetitionTeam(
                                                                            (
                                                                                prev
                                                                            ) =>
                                                                                prev.includes(
                                    ...
                                    {selectedCompetitionTeam.length > 0 && (
                                        <div className="mt-4 p-3 bg-accent rounded-lg">
                                            <p className="text-sm">
                                                <CheckCircle2 className="w-4 h-4 inline mr-1" />
                                                {selectedCompetitionTeam.length}{" "}
                        ...
                        {competitionFormData.competitionField && (
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Select a supervisor to guide your
                                        competition team
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                                        ...
                                                        >
                                                            <TableCell>
                                                                <Checkbox
                                                                    ...
                                                                    onCheckedChange={() =>
                                                                        setSelectedCompetitionSupervisor(
                                                                            supervisor.id
                                                                        )
                                                                    }
                                                                    disabled={
