  ...
  const reportTemplates = [
    {
      ...
      description: 'Overview of all projects (PKL, Thesis, Competition) organized by semester',
      icon: Briefcase,
      type: 'projects'
    },
    {
      ...
      description: 'Number of students supervised per lecturer with distribution analysis',
      icon: UserCheck,
      type: 'supervisors'
    },
    {
      ...
      description: 'Activity participation rates and engagement metrics by student',
      icon: TrendingUp,
      type: 'engagement'
    },
    {
      ...
      description: 'Comparative analysis of activities across departments',
      icon: BarChart3,
      type: 'department'
    },
    {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          <CardContent>
            <div className="space-y-1">
              <div className="flex items-baseline gap-2">
                <span className="text-3xl">{statistics.totalProjects}</span>
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-1">
              <div className="flex items-baseline gap-2">
                <span className="text-3xl">{statistics.totalSupervisors}</span>
              </div>
              <p className="text-xs text-muted-foreground">
                Avg {statistics.avgStudentsPerSupervisor} students/supervisor
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-1">
              <div className="flex items-baseline gap-2">
                <span className="text-3xl">{statistics.engagementRate}%</span>
              </div>
              <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-1">
              <div className="flex items-baseline gap-2">
                <span className="text-3xl">{statistics.departments}</span>
              </div>
              <p className="text-xs text-muted-foreground">
                Active programs
              </p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select parameters and export format to generate a custom report
          </CardDescription>
        </CardHeader>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded bg-primary/10 flex items-center justify-center flex-shrink-0">
                    {report.format === 'PDF' && <FileText className="w-5 h-5 text-primary" />}
                    {report.format === 'Excel' && <FileSpreadsheet className="w-5 h-5 text-primary" />}
                    {report.format === 'CSV' && <FileBarChart className="w-5 h-5 text-primary" />}
                  </div>
                  <div>
