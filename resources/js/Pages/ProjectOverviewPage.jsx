...
const ProjectType = "pkl" | "thesis" | "competition" | "all";
const ProjectStatus = "pending" | "ongoing" | "completed" | "cancelled";

const Project = [
    {
        id: "string",
        type: "pkl" | "thesis" | "competition",
        title: "string",
        teamMembers: "string",
        supervisor: "string",
    ...
    const [projects, setProjects] = useState([
        {
            ...
            endDate: "2024-12-15",
            description:
                "Implementing ERP system for manufacturing company to streamline business processes and improve operational efficiency.",
        ...
        },
        {
            ...
            endDate: "2025-01-20",
            description:
                "Developing a deep learning model using BERT for sentiment analysis of Indonesian text on social media platforms.",
            department: "Computer Science",
        },
        {
            id: "3",
            ...
            endDate: "2024-11-30",
            description:
                "IoT-based smart agriculture monitoring system with AI prediction for optimal crop growth and automated irrigation.",
        ...
        },
        {
            ...
            endDate: "2024-09-30",
            description:
                "Developed cross-platform mobile application for e-commerce startup with integrated payment gateway and real-time order tracking.",
        ...
        },
        {
            ...
            endDate: "2025-02-15",
            description:
                "Implementing blockchain technology to ensure transparency and traceability in supply chain management for pharmaceutical industry.",
        ...
        },
        {
            ...
            endDate: "2024-10-01",
            description:
                "Developed an AI chatbot for preliminary health diagnosis and medical information assistance using NLP and machine learning.",
            department: "Computer Science",
        },
        {
            id: "7",
            ...
            endDate: "2024-12-20",
            description:
                "Building interactive data analytics dashboard for financial institution to visualize customer behavior and transaction patterns.",
            department: "Information Systems",
        },
        {
            id: "8",
            ...
            endDate: "2025-03-10",
            description:
                "Developing AR-based educational application to enhance interactive learning experience for primary school students.",
            department: "Information Technology",
        },
        {
            id: "9",
            ...
            endDate: "2024-12-01",
            description:
                "IoT system for monitoring and optimizing green energy usage in smart buildings with real-time analytics and recommendations.",
            department: "Information Technology",
        },
        {
            id: "10",
            ...
            endDate: "2024-10-15",
            description:
                "Conducting comprehensive security assessment and penetration testing for banking IT infrastructure.",
            department: "Computer Science",
        },
        {
            id: "11",
            ...
            endDate: "2025-01-30",
            description:
                "Using computer vision and deep learning to automate quality inspection process in manufacturing production line.",
            department: "Computer Science",
        },
        {
            id: "12",
            ...
            endDate: "2024-11-25",
            description:
                "AI-based traffic prediction and management system for smart city implementation with real-time optimization.",
            department: "Software Engineering",
        },
    ]);
        ...
        const updatedProjects = projects.map((p) => {
            if (p.id === selectedProject.id) {
                return {
                    ...
                    ...formData,
                    teamMembers:
                        typeof formData.teamMembers === "string"
