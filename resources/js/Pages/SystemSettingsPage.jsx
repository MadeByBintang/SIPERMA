...
export function SystemSettingsPage() {
  ...
  const [maxCompetitionPerLecturer, setMaxCompetitionPerLecturer] = useState('2');
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="max-total">Max Students per Lecturer (Total)</Label>
              <Input
                id="max-total"
                type="number"
                min="1"
            ...
            <div className="space-y-2">
              <Label htmlFor="max-pkl">Max PKL Students per Lecturer</Label>
              <Input
                id="max-pkl"
                type="number"
                min="1"
            ...
            <div className="space-y-2">
              <Label htmlFor="max-thesis">Max Thesis Students per Lecturer</Label>
              <Input
                id="max-thesis"
                type="number"
                min="1"
            ...
            <div className="space-y-2">
              <Label htmlFor="max-competition">Max Competition Teams per Lecturer</Label>
              <Input
                id="max-competition"
                type="number"
                min="1"
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle>Registration & Approval Settings</CardTitle>
          </div>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-4 border rounded-lg">
            <div className="space-y-0.5">
              <Label htmlFor="registration-enabled">Enable Student Registration</Label>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            <div className="space-y-0.5">
              <Label htmlFor="require-approval">Require Lecturer Approval</Label>
              <p className="text-sm text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-4 border rounded-lg bg-orange-50 border-orange-200">
            <div className="space-y-0.5">
              <Label htmlFor="maintenance-mode" className="text-orange-900">
                Maintenance Mode
              </Label>
